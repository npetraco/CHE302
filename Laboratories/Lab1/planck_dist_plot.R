h   #Planck's const. FILL ME IN
cl  #Speed of light. FILL ME IN
kB  #Boltzmann's const. FILL ME IN

#-------------------------------------------------------------------------------------
#This is a function to plot the Plank distribution as a function of wavenumber.
#
#ARGUEMENTS:
#nut.min: The smallest wavenumber to use. Use something at least little laeger than 0.  
